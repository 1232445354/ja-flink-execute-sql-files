...
create table if not exists flightradar24_aircraft_list(
          ...
          'scan.startup.timestamp-millis' = '1720441828000',
          'format' = 'json',
...
from flightradar24_aircraft_list a
         left join dws_aircraft_info FOR SYSTEM_TIME AS OF a.proctime as b
...
select
    ...
    t5.c_name                                      as position_country_name,
...
from tmp_fr24_aircraft_01 a
         ...
         left join dim_country_info FOR SYSTEM_TIME AS OF a.proctime as t3
                   on a.country_code3=t3.code3

         left join dim_sea_area FOR SYSTEM_TIME AS OF a.proctime as t4
                   on a.sea_id = t4.id

         left join dim_country_code_name_info FOR SYSTEM_TIME AS OF a.proctime as t5
                   on t3.code2 = t5.country_code2 and 'COMMON' = t5.source;
...
select
    ...
    cast(null as string)                as flightStatus,
