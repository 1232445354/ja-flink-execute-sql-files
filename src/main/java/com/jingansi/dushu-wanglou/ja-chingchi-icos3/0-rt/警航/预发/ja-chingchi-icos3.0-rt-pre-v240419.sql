...
create table iot_device_message_kafka (
    ...
    -- 截图数据
      ...
      -- 'scan.startup.timestamp-millis' = '1727070385000',
      'format' = 'json',
...
create table device_media_datasource (
      ...
      'connector' = 'jdbc',
      'url' = 'jdbc:mysql://135.100.11.103:3306/dushu-v3?useSSL=false&characterEncoding=UTF-8&serverTimezone=GMT%2B8&autoReconnect=true', -- ECS环境
...
where abs(coalesce(`timestamp`,message.`timestamp`)/1000 - UNIX_TIMESTAMP()) <=86400;
