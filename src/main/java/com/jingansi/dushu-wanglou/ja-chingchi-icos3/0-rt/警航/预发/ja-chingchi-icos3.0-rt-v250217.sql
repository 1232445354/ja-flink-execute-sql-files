...
-- 'fenodes' = '172.21.30.202:30030',
     'table.identifier' = 'dushu.dwd_radar_target_all_rt_pre',
     'username' = 'admin',
...
create table users (
     ...
     'connector' = 'jdbc',
     'url' = 'jdbc:mysql://135.100.11.103:3306/ja-4a?useSSL=false&characterEncoding=UTF-8&serverTimezone=GMT%2B8&autoReconnect=true',
