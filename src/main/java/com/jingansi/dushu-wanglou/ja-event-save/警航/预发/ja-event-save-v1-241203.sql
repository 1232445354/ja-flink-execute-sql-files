...
set 'pipeline.name' = 'ja-event-save-pre';
...
SET 'state.checkpoints.dir' = 's3://flink/flink-checkpoints/ja-event-save-pre' ;
...
create table dwd_photoelectric_target_all_rt_source(
     ...
     'fenodes' = 'doris-fe-service.bigdata-doris.svc.cluster.local:9999',  -- k8s部署
-- 'fenodes' = '172.21.30.202:30030',                                       -- 物理机器部署
     'table.identifier' = 'dushu.dwd_photoelectric_target_all_rt_source_pre',
     'username' = 'admin',
     'password' = 'Jingansi@110',
     'doris.request.tablet.size'='3',
     'doris.request.read.timeout.ms'='30000',
...
create table dwd_event_save_all(
     ...
     'fenodes' = 'doris-fe-service.bigdata-doris.svc.cluster.local:9999',  -- k8s部署
-- 'fenodes' = '172.21.30.202:30030',                                       -- 物理机器部署
     'table.identifier' = 'dushu.dwd_event_save_all_pre',
     'username' = 'admin',
     'password' = 'Jingansi@110',
     'doris.request.tablet.size'='3',
     'doris.request.read.timeout.ms'='30000',
...
create table device (
     ...
     'connector' = 'jdbc',
     'url' = 'jdbc:mysql://135.100.11.103:3306/dushu-v3?useSSL=false&characterEncoding=UTF-8&serverTimezone=GMT%2B8&autoReconnect=true&autoReconnect=true',
