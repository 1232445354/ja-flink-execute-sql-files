...
create function block_white_list_flag as 'com.jingan.udf.merge.BlackWhiteCarShipFlagUdf1';
...
select
    t1.*,
    block_white_list_flag(label_value,define_type,t2.sip_no,t3.sip_no) as alarm_flag   -- 车牌号，类型（车牌还是船牌），黑名单号，白名单号
