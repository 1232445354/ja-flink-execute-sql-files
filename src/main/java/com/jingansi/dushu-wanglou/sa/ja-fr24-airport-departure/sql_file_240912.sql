...
set 'pipeline.name' = 'ja_fr24_airport_departure';
...
set 'state.checkpoints.dir' = 's3://ja-flink/flink-checkpoints/flink_airport_departure';


drop table if exists  fr24_airport_departure_kafka;
create table fr24_airport_departure_kafka(
      ...
      'properties.group.id' = 'fr24_airport_departure_2_id',
...
drop table if exists  ods_airport_flight_departure;
create table ods_airport_flight_departure(
      ...
      'table.identifier' = 'sa.ods_airport_flight_departure',
      'username' = 'admin',
...
-- 1. 将kafka数据写入doris表
insert into ods_airport_flight_departure
select
    flight_airport,
    std_unix_time,
    acquire_time,
