...
-- description: 萧山对接
-- version: ads-security-person-stay-time-alarm-rt-v250812-xiaoshan
--********************************************************************--
...
create table ja_device_index_kafka_guobiao (
                                               ...
                                               rt as to_timestamp_ltz(UNIX_TIMESTAMP(gtime)*1000,3),
...
-- 人员基本信息表
create table security_person_info(
...
select
    ...
    a.acquire_timestamp_format  as acquisition_time,
    ...
    a.longitude as gd_longitude                                   , -- 经度
    a.latitude  as gd_latitude                                    , -- 纬度
...
from tmp_01_guobiao a
         left join security_person_info FOR SYSTEM_TIME as of a.proctime as b
