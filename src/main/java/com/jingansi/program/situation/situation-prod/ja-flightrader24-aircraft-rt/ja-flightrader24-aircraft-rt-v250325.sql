...
-- description: flightrader24飞机轨迹(单独)
-- version: ja-flightrader24-aircraft-rt-v250325
--********************************************************************--
...
select
    ...
    if(a.registration='N/A',cast(null as string),a.registration) as registration, -- 飞机的注册号，唯一标识特定飞机
    ...
    feeder,
    proctime
from flightradar24_aircraft_list as a;
...
--   t1.*,
--    case
--     when t1.country_code in('IN','US','JP','AU','TW') and is_military = 1 then '1'  -- 美日..军机 敌方
--     when t1.country_code in ('CN','HK','MO') and is_military = 1 then '2' -- 中国的军机 我方
--     when t1.country_code in ('CN','HK','MO') and is_military = 0 then '3' -- 中国的非军机 友方
