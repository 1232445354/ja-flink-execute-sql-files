...
--********************************************************************--
set 'pipeline.name' = 'ja-ais-vessel-detail-port-rt';
...
set 'state.checkpoints.dir' = 's3://ja-flink/flink-checkpoints/ja-ais-vessel-detail-port-rt-checkpoint';
...
select
    ...
    if(t1.last_port_country_code is not null,t1.last_port_country_code,'NONE') as last_port_country_code,
    ...
    if(t1.next_port_country_code is not null,t1.next_port_country_code,'NONE') as next_port_country_code,
...
from tmp_vessel_port_03 as t1
    ...
    FOR SYSTEM_TIME AS OF t1.proctime as t2
                   on if(t1.last_port_country_code is not null,t1.last_port_country_code,'NONE') = t2.flag_country_code
                       and 'FLEETMON' = t2.belong_type
         left join dim_vessel_country_code_list
    FOR SYSTEM_TIME AS OF t1.proctime as t3
                   on if(t1.next_port_country_code is not null,t1.next_port_country_code,'NONE') = t3.flag_country_code
...
select
    ...
    if(t1.flag_country_code is not null,t1.flag_country_code,'NONE') as flag_country_code           ,
...
from tem_ais_kafka_02 as t1
    ...
    FOR SYSTEM_TIME AS OF t1.proctime as t6
                   on if(t1.flag_country_code is not null,t1.flag_country_code,'NONE') = t6.flag_country_code
