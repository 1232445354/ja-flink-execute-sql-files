...
start_day="2023-11-08 00:00:00"
end_day="2023-11-08 23:59:59"
date_format="+%Y-%m-%d %H:%M:%S"
...
current_timestamp2=$((current_timestamp1 + 7200))
...
while [ "$current_timestamp1" -le "$end_timestamp" ]; do
  ...
  current_timestamp1=$((current_timestamp1 + 7200))
  current_timestamp2=$((current_timestamp2 + 7200))
  echo -en "sleep中.......\n"
  sleep 5s
done
