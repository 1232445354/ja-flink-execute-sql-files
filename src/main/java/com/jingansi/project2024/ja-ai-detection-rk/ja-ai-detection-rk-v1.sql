...
set
''pipeline.name'' = ''ja-ai-detection-rt'';
...
600000'';
SET
''state.checkpoints.dir'' = ''s3://ja-flink/flink-checkpoints/ja-ai-detection-rt'' ;
...
select device_id,
       ...
       object_label,
       object_sub_label,
       '' ja-flink'' as create_by, from_unixtime(unix_timestamp()) as update_time
