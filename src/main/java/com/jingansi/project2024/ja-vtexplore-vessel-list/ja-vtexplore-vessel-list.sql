...
create table ais_vtexplorer_ship_list(
      ...
      'connector' = 'kafka',
      'topic' = 'ais_vtexplorer_ship_list',
      'properties.bootstrap.servers' = 'kafka.kafka.svc.cluster.local:9092',
      'properties.group.id' = 'ais_vtexplorer_ship_list_2',
      -- 'scan.startup.mode' = 'latest-offset',
      'scan.startup.mode' = 'timestamp',
      'scan.startup.timestamp-millis' = '1710851382000',
      'format' = 'json',
...
drop table if exists dwd_vt_vessel_status_info;
create table dwd_vt_vessel_status_info(
                                          mmsi                 			string  	, -- mmsi
                                          imo                  			string		, -- imo
                                          acquire_timestamp_format        string      , -- 采集时间戳格式化
                                          acquire_timestamp    			bigint      , -- 采集时间戳
     ...
     'connector' = 'doris',
     'fenodes' = 'doris-fe-service.bigdata-doris.svc.cluster.local:9999',
     'table.identifier' = 'sa.dwd_vt_vessel_status_info',
     'username' = 'admin',
     'password' = 'Jingansi@110',
     'doris.request.tablet.size'='1',
     'doris.request.read.timeout.ms'='30000',
...
insert into dwd_vt_vessel_status_info
select
    mmsi,
    imo,
    acquire_timestamp_format,
