...
"dwd_bhv_satellite_rt epoch_time 0 0"                       # 卫星全量数据
...
"dws_et_aircraft_info acquire_time 0 0"                     # 飞机实体表
...
arrayList=(
"dwd_bhv_airport_flight_rt acquire_time 2 21600"                      # 6 hour 出发到达航班
"dws_vessel_bhv_track_rt acquire_time 5 1800"                         # 30 minute 船舶轨迹
