...
select
    *,
    case
        when country_code in('IN','US','JP','AU','TW') and is_military = 1 then 'ENENY'  -- 美日..军机 敌方
        when country_code in ('CN','HK','MO') and is_military = 1 then 'OUR_SIDE'                -- 中国的军机 我方
        when country_code in ('CN','HK','MO') and is_military = 0 then 'FRIENDLY_SIDE'           -- 中国的非军机 友方
